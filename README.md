# Проект java
Лабораторная работа №2. Выполнил Иванов Иван ИТ-13
...
**Вывод:**
Маршрут F -> D: F -> A -> C -> E -> D
Путь как массив: F A C E D
...
City B = new TwoWayCity("B");Вывод:ection(B, 1);
**Вывод:**
A → B(1)
B → A(1)
...
Bird parrot = new Parrot("Привет, мир!");
sparrow.sing();
cuckoo.sing();
parrot.sing();
**Вывод:**
