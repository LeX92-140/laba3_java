...
## Описание проекта
Проект представляет собой реализацию 10 задач по объектно-ориентированному программированию на Java с использованием продвинутых концепций ООП: инкапсуляция, наследование, полиморфизм, пакеты. Все классы организованы в логическую структуру пакетов.
